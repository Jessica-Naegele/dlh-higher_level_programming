...
for line in sys.stdin:
    parts = line.split()  # creates a list with every single aspect of the input
    ...
    line_count += 1  #to enable printing after every 10th line
    if line_count % 10 == 0:  # print must be inside the loop, otherwise, it will not print
